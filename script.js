...
if(galleryContainer) {
    for(let i = 1; i <= 20; i++) {
        ...
        // Skrypt próbuje wczytać zdjęcia 1.jpg, 2.jpg... z folderu "img"
        // W razie braku zdjęcia (onerror) odpala poprzedniego placeholdera dla estetyki
        div.innerHTML = `
            <img src="img/${i}.jpg" alt="Zdjęcie obiektu ${i}" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1555854877-bab0e564b8d5?auto=format&fit=crop&q=80&w=400&sig=${i}'">
        `;
